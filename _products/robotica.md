...
.btn-primary {
  ...
  background-color: #3cbb98;
  border-color: #3cbb98;
}

.btn-primary:active, .btn-primary:focus, .btn-primary:hover {
  background-color: #339e80 !important;
  border-color: #339e80 !important;
  color: white;
}
...
#portfolio .portfolio-item .portfolio-link .portfolio-hover {
  ...
  opacity: 0;
  background: rgba(60, 187, 152, 0.9);
}
...
<body id="page-top">
  <script type="text/javascript" src="https://apiv2.popupsmart.com/api/Bundle/354284" async></script>
